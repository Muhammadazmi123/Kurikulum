              ...
              <button type="button" class="btn btn-outline-primary block mb-3" data-bs-toggle="modal"
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td>
                        <a href="/jadwal_piket/edit/{{ $p->id }}" class="btn icon btn-sm btn-primary"><i class="bi bi-pencil"></i></a>
                        |
                        <a href="/jadwal_piket/hapus/{{ $p->id }}" class="btn icon btn-sm btn-danger"><i class="bi bi-x"></i></a>
                      </td>
                    </tr>
                  </tbody>
                  @endforeach
