...
class JadwalPiketController extends Controller
{
    ...
    public function edit($id)
    {
        ...
        $jadwal_piket = DB::table('jadwal_piket')
            ->where('id', $id)
            ->get();
    ...
    public function import(Request $request){
      ...
      Excel::import(new JadwalPiketImport, request()->file('file'));
      //jika berhasil kembali ke halaman sebelumnya
      return back();
  }
  public function export() 
  {
      return Excel::download(new JadwalPiketExport, 'jadwal_piket.xlsx');
      return back();
  }
}
